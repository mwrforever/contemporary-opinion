...
class NotebookShopping {
  ...
  factory NotebookShopping.fromJson(Map<String, dynamic> m) => NotebookShopping(
        id: (m['id'] ?? '') as String,
        item: (m['item'] ?? '') as String,
        expectedPrice: m['expected_price'] is num
            ? m['expected_price'] as num
            : (m['expectedPrice'] is num ? m['expectedPrice'] as num : 0),
        actualPrice: m['actual_price'] is num
            ? m['actual_price'] as num
            : (m['actualPrice'] is num ? m['actualPrice'] as num : 0),
